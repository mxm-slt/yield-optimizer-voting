...
import "./libraries/StratManager.sol";
import "./libraries/FeeManager.sol";

contract VwaveMaxi is StratManager, FeeManager {
    ...
    event ChargedFees(uint256 callFees, uint256 vwaveFees, uint256 strategistFees);
    ...
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _vwaveFeeRecipient) public {
        want = _want;
